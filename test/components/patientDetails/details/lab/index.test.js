...
jest.mock('../../../../../src/components/patientDetails/details/lab', () => ({
  __esModule: true,
  default: function MockLab({ onTabChange = () => {}, onAction = () => {} }) {
...
import Lab from '../../../../../src/components/patientDetails/details/lab';

describe('details/lab (mocked)', () => {
  test('switch tab and act', () => {
    const onTabChange = jest.fn();
    const onAction = jest.fn();
    render(<Lab onTabChange={onTabChange} onAction={onAction} />);
