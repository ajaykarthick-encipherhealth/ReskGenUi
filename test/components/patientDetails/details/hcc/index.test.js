...
jest.mock('../../../../../src/components/patientDetails/details/hcc', () => ({
  __esModule: true,
  default: function MockHcc({ onTabChange = () => {}, onAction = () => {} }) {
...
import Hcc from '../../../../../src/components/patientDetails/details/hcc';

describe('details/hcc (mocked)', () => {
  test('switch tab and act', () => {
    const onTabChange = jest.fn();
    const onAction = jest.fn();
    render(<Hcc onTabChange={onTabChange} onAction={onAction} />);
