...
import { getColorValue, statusFormate } from "../../../../../utils/reusable";
...
export const WorkFlow = ({ chartType, chartChange, selectedRole }) => {
  const data = chart5Data;
  if (chartType === "card") {
    return (
...
export const DailyTask5 = ({ chartType, chartChange, selectedRole, windowWidth }) => {
  return (
    <div className="d-flex gap-3 justify-content-between flex-wrap">
      ...
      <div className="d-flex justify-content-center w-100 my-2 gap-4 flex-wrap">
        {dailyTaskData[0]?.series?.filter((item)=>dailyTaskData5.includes(item.name))?.map((item) => (
...
export const DailyTask7 = ({ chartType, chartChange, selectedRole, windowWidth }) => {
  return (
    <div className="d-flex gap-3 justify-content-between flex-wrap">
      <div className="d-flex justify-content-between align-items-center w-100">
        <FontAwesomeIcon
      ...
      <div className="d-flex justify-content-center w-100 my-2 gap-4 flex-wrap">
        {dailyTask7Data[0]?.series?.filter((item)=>dailyTaskData7.includes(item.name))?.map((item) => (
          <div key={item.name} className="d-flex align-items-center">
            <div
              style={{
                backgroundColor: item.color,
