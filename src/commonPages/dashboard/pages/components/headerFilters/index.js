...
} from "../../../../../utils/reusable"; // Import reusable function
import dayjs from "dayjs";
import { useRef } from "react";
import RegularButton from "../../../../../components/button";
import { roleAccessList } from "../../../../../commonPages/dashboard/component/function";
...
const index = ({
  ...
  const { aliasName = "" } = getLocalStored();
          ...
          <section className="d-flex justify-between" style={{ width: "100%" }}>
            ...
            >
              <div
                className="d-flex"
                style={{
                  width: isCustom && "200px",
                  minWidth: isCustom && "150px"
                }}
              >
