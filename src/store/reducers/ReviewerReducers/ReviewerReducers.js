import { GET_PATIENT_DETAILS ,GET_MEAT_QUERY,GET_SECTION_COLOR,GET_HCC_FILE,GET_DOS_PAGE,GET_RADIOLOGY_DETAILS,GET_RADIOLOGY_FILE,GET_LAB_DETAILS,GET_LAB_FILE,GET_DOS_LIST} from "../../actions/ReviewerAction/PatientDetailsAction";
  ...
  export const ReviewerReducers = (state = initialState, action) => {
    ...
    if (action.type === GET_DOS_LIST) {
      return {
        ...state,
        patientDosList: action.payload,
      };
    }
    return state;
  };
