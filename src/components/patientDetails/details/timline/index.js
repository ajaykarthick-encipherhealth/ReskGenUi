...
export const getMeatEditDeatils = (viewValue) => {
  let sectionMapArr = (
    <>
...
export const getEditDeatils = (viewValue) => {
  let sectionMapArr = (
    <>
      <div className="d-flex justify-content-end">
        <CloseCircleFilled
...
export const getTimelineHeading = (item, index) => {
  switch (item.action) {
    case "MOVED_INVALID_TO_VALID":
      return (
    ...
    case "AUDIT_DECLINED":
      return (
        <div className="d-flex">
          ...
          to <span className={visitStyles?.auditdeclined}>AUDIT_DECLINED</span>
        </div>
      );
