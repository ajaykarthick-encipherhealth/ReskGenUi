...
const Codes = ({ data , loading ,setCurrentButton }) => {
  ...
  const tableData = [
    {
      include: 'high blood pressure hypertension (arterial),(bengin),(essential),(malignant),(primary),(systamatic)',
      exclude1: 'hypertensive disease,complicating pregnancy, and child birth(010-011,013-016)',
      exclude2: 'essential primary hypertension involving vessels of brain(160-169),essential (primary) hypertension involving vessels of eye'
    },
  ...
  return (
    <>
      <div className="d-flex gap-1 mt-3">
        <ArrowLeftOutlined style={{ fontSize: "18px" }} onClick={handleArrowClick}  />
