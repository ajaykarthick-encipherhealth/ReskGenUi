...
const MoreFilter = ({
  ...
  const PopContent = (
    <>
      ...
      <div
        style={{
          height: activeFilters?.length > 3 ? "170px" : "auto",
          overflow: "scroll",
        }}
      >
      ...
      <div className="d-flex justify-content-between">
        <div
          ...
          id={
            id
              ? createIdGen("clearFilters" + id)
              : createIdGen(
                  "clearFilters" + router.pathname.replaceAll("/", " ")
                )
          }
        >
          Clear Filters
        ...
        <div
          ...
          id={
            id
              ? createIdGen("resetFilters" + id)
              : createIdGen(
                  "resetFilters" + router.pathname.replaceAll("/", " ")
                )
          }
        >
          Reset
  ...
  return (
    <div
      id={
        id
          ? createIdGen("filterIcon" + id)
          : createIdGen("filterIcon" + router.pathname.replaceAll("/", " "))
      }
      className="d-flex"
