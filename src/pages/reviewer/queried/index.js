...
const QUERIED = ({
  ...
  const gotoPatientDetails = (data) => {
    ...
    if (data.computing == 2) {
      ...
      controller.abort();
      setStorage("patientId", data.patientId);
      setStorage("routeBackTo", "/reviewer/queried");
      getRoutedData(params);
      router.push("/reviewer/queried/details");
    } else {
    ...
    <div className={`show `}>
      ...
      <div className="content-body">
        <div className="container-fluid table-responsive active-projects task-table">
          ...
          {/* <div className="w-80 d-flex align-items-end justify-content-end">
...
export default enhancer(QUERIED);
