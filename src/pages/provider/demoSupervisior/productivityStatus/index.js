...
const SupervisiorProducitivity = () => {
  ...
  useEffect(() => {
    ...
    const chartId =
      viewchart === "day"
        ? "6643029c-9368-4247-8331-8a3b679cba33"
        : viewchart === "month"
        ? "6643029c-9368-47e9-89cc-8a3b679cba37"
        : "6643029c-9368-4939-83b8-8a3b679cba35";
  ...
  useEffect(() => {
    const renderCharts = () => {
      if (chart) {
        chart.render(document.getElementById("supervisior-chart"));
      }
    };
    renderCharts();
  }, [chart]);
