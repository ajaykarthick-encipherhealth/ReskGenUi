...
export default function Patient() {
  ...
  const getAllList = async () => {
    const response = await axios.get(
      ENDPOINTS.apiEndoint + "dbservice/patient/getall?userid=12345"
    );
  ...
  const subscribe = async () => {
    ...
    if (!status) {
      ...
      const resoureUrl =
        "https://hcc.encipherhealth.com/secure/dbservice/events?userid=12345";
      const events = new EventSourcePolyfill(
        "https://hcc.encipherhealth.com/secure/aiservice/ai/events?userId=12345&tenantId=b4d34e42-79a6-478e-b3af-12ce7311fa09",
        {
          headers: {
                      ...
                      >
                        ...
                        <div className="d-flex justify-content-between mrt-15">
                          <span>
                            ...
                            <strong>{pageIndex + 1} of 10</strong>
                            {""}
                          </span>
