...
const Searches = ({
  ...
  const column = [
    { actualField: "code", value: "code",active:true },
    { name: "description", value: "description" ,active:true},
    { name: "years", value: "years", isarray: true,active:true },
    { name: "billable", value: "billable",active:true },
    {
      name: "active",
      value: {
        action: [
